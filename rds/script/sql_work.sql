...
VALUES (1, SYSDATE() - INTERVAL 3 DAY, '서울 강남구', '899-6666', '결제완료', (SELECT CNO FROM CUSTOMERS WHERE CNAME = '김철수'));

INSERT INTO orderdetail (orderno, pno, qty, cost)
VALUES (1, (SELECT PNO FROM PRODUCTS WHERE PNAME = '삼양라면'), 50, 1000);
...
INSERT INTO orders (orderno, orderdate, address, phone, STATUS, cno)
VALUES (2, SYSDATE() - INTERVAL 2 DAY, '부산 수영구', '337-5000', '결제완료', (SELECT CNO FROM CUSTOMERS WHERE CNAME = '이영희'));

INSERT INTO orderdetail (orderno, pno, qty, cost)
VALUES (2, (SELECT PNO FROM PRODUCTS WHERE PNAME = '새우깡'), 100, 1500);

INSERT INTO orderdetail (orderno, pno, qty, cost)
VALUES (2, (SELECT PNO FROM PRODUCTS WHERE PNAME = '월드콘'), 150, 2000);
...
INSERT INTO orders (orderno, orderdate, address, phone, STATUS, cno)
VALUES (3, SYSDATE() - INTERVAL 1 DAY, '광주 북구', '652-2277', '결제완료', (SELECT CNO FROM CUSTOMERS WHERE CNAME = '오민수'));

INSERT INTO orderdetail (orderno, pno, qty, cost)
VALUES (3, (SELECT PNO FROM PRODUCTS WHERE PNAME = '빼빼로'), 100, 2000);

INSERT INTO orderdetail (orderno, pno, qty, cost)
VALUES (3, (SELECT PNO FROM PRODUCTS WHERE PNAME = '코카콜라'), 50, 1800);
...
INSERT INTO orders (orderno, orderdate, address, phone, STATUS, cno)
VALUES (4, DEFAULT, '제주 동광양', '352-4657 ', '결제완료', (SELECT CNO FROM CUSTOMERS WHERE CNAME = '최진국'));
