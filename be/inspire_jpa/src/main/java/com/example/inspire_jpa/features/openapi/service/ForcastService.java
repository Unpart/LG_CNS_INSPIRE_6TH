...
public class ForcastService {
    ...
    public List<ForcastResponseDTO> connection(ForcastRequestDTO request){
        System.out.println("debug forcast service connection");
        String requestUrl = UriComponentsBuilder
                                ...
                                .toUriString();
        System.out.println("debug forcast service requestUrl : " + requestUrl);
        ...
        try {
            ...
            System.out.println("debug forcast service connection status : " + status);
            if(status == 200) {
